...
export default async function MathsExamBoardPage({
  params,
}: {
  ...
  const boards = getExamBoardsForLevel("maths", level);
    ...
    <main className="space-y-8">
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-3 text-sm">
          <Link className="apple-subtle inline-flex" href="/maths/levels/resources">
            ← Back to levels
          </Link>
